...
class Chinelas extends CI_Controller {
	...
	function index(){
		...
		$this->load->view('admin/chinelas/chinelas', $data);
	}
	...
	public function nuevo(){
		...
		$this->load->view('admin/header');
		$this->load->view('admin/nav');
		$this->load->view('admin/chinelas/nuevo');
	}
	...
	function insert(){
		...
		$this->load->library('upload');
	        ...
	        if(!empty($_FILES['foto']['name'])){
		        $config['upload_path'] = './img/chinelas/';
	    ...
	    $this->chinelasModel->insert($nombre, $titulo, $subTitulo, $opcional, $descripcion, $condicion, $colores, $pagos, $envios, $consultas, $email, $whatsapp, $tabla, $collage, $precio, $articulo, $foto, $foto2, $foto3, $foto4, $foto5);
	        
	   header("location:" . base_url() . "chinelas");
	}
	...
	function editar(){
		...
		$this->load->view('admin/header');
		$this->load->view('admin/nav');
		$this->load->view('admin/chinelas/editar', $data);
	}
	...
	function actualizar(){
	    ...
	    $this->chinelasModel->actualizar($id, $nombre, $titulo, $subTitulo, $opcional, $descripcion, $condicion, $colores, $pagos, $envios, $consultas, $email, $whatsapp, $tabla, $collage, $precio, $articulo, $foto, $foto2, $foto3, $foto4, $foto5);
	...
	function eliminar(){
		$id = $this->uri->segment(3);
		$this->chinelasModel->eliminar($id);
	...
	function buscar(){
		...
		if($query){
			$result = $this->chinelasModel->buscar(trim($query));
			$total = $this->chinelasModel->totalResultados(trim($query));
			if($result != FALSE){
				$data = array(
					'result' => $result,
					'total' => $total
