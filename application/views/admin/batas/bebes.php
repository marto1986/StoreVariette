<a href="<?php echo base_url()?>batas/nuevoBebes"><button class="nuevo nuevo1"><i class="fa fa-plus" aria-hidden="true"></i></button></a>
	<article>
	<?php if(is_array($batas)){ ?>
	<?php foreach($batas as $row){ ?>
	<?php if($row->bebes == 1){ ?>
        <div class="cajas">
        	<a href="<?php echo base_url()?>batas/editarBebes/<?php echo $row->id?>">
	        	<div id="" class="caja">
	        		<div class="cuadro">
