<div class="formulario">
	<form id="form" name="form" action="<?php echo base_url() ?>batas/actualizarAdultos/<?php echo $id?>" method="post" enctype="multipart/form-data">
		...
		<input type="text" name="whatsapp" id="whatsapp" value="<?php echo $whatsapp ?>"><br><br>
