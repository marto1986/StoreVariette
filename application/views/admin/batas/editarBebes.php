<div class="formulario">
	<form id="form" name="form" action="<?php echo base_url() ?>batas/actualizarBebes/<?php echo $id?>" method="post" enctype="multipart/form-data">
		...
		<br><br>
		<input type="hidden" class="w3-check" name="bebes" id="bebes" value="1">
		<br><br>
		<input type="hidden" class="w3-check" name="ninos" id="ninos" value="">
		<br><br>
		<input type="hidden" class="w3-check" name="adultos" id="adultos" value="">
		<input type="hidden" class="w3-check" name="tabla" id="tabla" value="0">
	...
	<form id="form" name="form" action="<?php echo base_url() ?>batas/eliminarBebes/<?php echo $id?>" method="post" enctype="multipart/form-data">
