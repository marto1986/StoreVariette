<div class="formulario">
	<form id="form" name="form" action="<?php echo base_url() ?>batas/actualizar/<?php echo $id?>" method="post" enctype="multipart/form-data">
		...
		<br><br>
		<input type="hidden" class="w3-check" name="ninos" id="ninos" value="1">
		...
		<input type="hidden" class="w3-check" name="collage" id="collage" value="1">
                <br><br>
		<input type="hidden" class="w3-check" name="adultos" id="adultos" value="">
	...
	<form id="form" name="form" action="<?php echo base_url() ?>batas/eliminar/<?php echo $id?>" method="post" enctype="multipart/form-data">
