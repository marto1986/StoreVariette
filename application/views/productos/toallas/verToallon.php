...
<div class="slider2">
  <?php if(!empty($foto)){ ?>
  <div class="slide"><img width="350" src="<?php echo base_url() ?>img/toallas/<?php echo $foto ?>"></div>
  <?php } ?>
  <?php if(!empty($foto2)){ ?>
  <div class="slide"><img width="350" src="<?php echo base_url() ?>img/toallas/<?php echo $foto2 ?>"></div>
  <?php } ?>
  <?php if(!empty($foto3)){ ?>
  <div class="slide"><img width="350" src="<?php echo base_url() ?>img/toallas/<?php echo $foto3 ?>"></div>
  <?php } ?>
  <?php if(!empty($foto4)){ ?>
  <div class="slide"><img width="350" src="<?php echo base_url() ?>img/toallas/<?php echo $foto4 ?>"></div>
  <?php } ?>
  <?php if(!empty($foto5)){ ?>
  <div class="slide"><img width="350" src="<?php echo base_url() ?>img/toallas/<?php echo $foto5 ?>"></div>
  <?php } ?>
</div>
...
<div class="container-fluid" style="width:80%; text-align:center">
  ...
  <?php if(!empty($collage)){ ?>
    <div>
      <img width="100%" src="<?php echo base_url() ?>img/collage/collage-toallon.jpg">
    </div>
  <?php } ?>
