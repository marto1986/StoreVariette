<div class="formulario">
	<form id="form" name="form" action="<?php echo base_url() ?>toallas/actualizar/<?php echo $id?>" method="post" enctype="multipart/form-data">
		...
		<br><br>
		<input type="hidden" class="w3-check" name="toalla" id="toalla" value="1">
		<br><br>
		<input type="hidden" class="w3-check" name="toallon" id="toallon" value="">
		<br><br>
		...
		<span>Foto Principal</span>
			<img src="<?php echo base_url()?>img/toallas/<?php echo $foto ?>">	
		</div>
		<?php } ?>
		<?php if(!empty($foto2)){ ?>
		<div class="minuaturas">
			<img src="<?php echo base_url()?>img/toallas/<?php echo $foto2 ?>">	
		</div>
		<?php } ?>
		<?php if(!empty($foto3)){ ?>
		<div class="minuaturas">
			<img src="<?php echo base_url()?>img/toallas/<?php echo $foto3 ?>">	
		</div>
		<?php } ?>
		<?php if(!empty($foto4)){ ?>
		<div class="minuaturas">
			<img src="<?php echo base_url()?>img/toallas/<?php echo $foto4 ?>">	
		</div>
		<?php } ?>
		<?php if(!empty($foto5)){ ?>
		<div class="minuaturas">
			<img src="<?php echo base_url()?>img/toallas/<?php echo $foto5 ?>">	
		</div>
		<?php } ?>
		...
		<?php } ?>
		<div id="error" style="display:none">!Error! Debe elegir una opción</div>
		<input type="submit" value="Guardar" id="guardar" name="submit">
	</form>
	<form id="form" name="form" action="<?php echo base_url() ?>toallas/eliminarToallon/<?php echo $id?>" method="post" enctype="multipart/form-data">
