...
<div class="container-fluid" style="width:80%; text-align:center">
  ...
  <?php if(!empty($tabla)){ ?>
    <div>
      <img width="100%" class="img-thumbnail" src="<?php echo base_url() ?>img/tablas/ninios.jpg">
    </div>
  <?php } ?>
  <?php if(!empty($collage)){ ?>
    <div>
      <img width="100%" class="img-thumbnail" src="<?php echo base_url() ?>img/collage/collage-adulto.jpg">
    </div>
  <?php } ?>
