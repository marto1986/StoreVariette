...
<script src="<?php echo base_url()?>lib/lightbox.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>css/productos/footerForm.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>css/promo.css">
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>css/productos/productos.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>css/jquery.bxslider.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>css/productos/sliderDemo.css">
