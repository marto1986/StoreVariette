<div class="formulario">
	<form id="form" name="form" action="<?php echo base_url() ?>pantuflas/actualizar/<?php echo $id?>" method="post" enctype="multipart/form-data">
		<label for="nombre">Ingresa la Foto Principal</label>
		...
		<input type="text" id="articulo" name="articulo" value="<?php echo $articulo; ?>"/>
		<br><br>
		...
		<div class="minuaturas">
			<img src="<?php echo base_url()?>img/pantuflas/<?php echo $foto ?>">	
		</div>
		<?php } ?>
		<?php if(!empty($foto2)){ ?>
		<div class="minuaturas">
			<img src="<?php echo base_url()?>img/pantuflas/<?php echo $foto2 ?>">	
		</div>
		<?php } ?>
		<?php if(!empty($foto3)){ ?>
		<div class="minuaturas">
			<img src="<?php echo base_url()?>img/pantuflas/<?php echo $foto3 ?>">	
		</div>
		<?php } ?>
		<?php if(!empty($foto4)){ ?>
		<div class="minuaturas">
			<img src="<?php echo base_url()?>img/pantuflas/<?php echo $foto4 ?>">	
		</div>
		<?php } ?>
		<?php if(!empty($foto5)){ ?>
		<div class="minuaturas">
			<img src="<?php echo base_url()?>img/pantuflas/<?php echo $foto5 ?>">	
		</div>
		<?php } ?>
	...
	<form id="form" name="form" action="<?php echo base_url() ?>pantuflas/eliminar/<?php echo $id?>" method="post" enctype="multipart/form-data">
